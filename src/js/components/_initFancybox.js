...
$('[data-fancybox="gallery"]').fancybox({
  ...
  onInit: function(instance) {
    // let content = $(instance.current.$content[0]).wrapAll('<div class=wrapElement></div>');
    // console.log(instance.$content);
    // $('.fancybox-content').wrapAll('<div class=wrapElement></div>');
  },
  onInit: function() {
    let wrap = $('.fancybox-stage').wrapAll('<div class=wrapElement></div>');
    $('.wrapElement').append(`
